        ...
        Row(
          ...
          decoration: ShapeDecoration(
            ...
            shadows: const [
              ...
              child: Lottie.asset('assets/iced_coffee.json', width: 150,
              height: 150,),
            ),
          ),
          InkWell(
          ...
          decoration: ShapeDecoration(
            ...
            shadows: const [
              ...
              child: Lottie.asset('assets/hot_coffee.json', width: 150,
              height: 150,),
            ),
          ),
        ]),
            ...
            if (state is GetHotCoffeIsloading) {
              ...
              .addCard(
                  cardEntity: CardEntity(
                      cardId: "",
                      cardImage:state.hotCoffe![index].imageUrl.toString(),
                      cardName:  state.hotCoffe![index].name.toString(),
                      cardPrice: state.hotCoffe![index].price!.toInt(),
                      uid: state.uuid)).then((value){
